      ...
      <body className={inter.className}>
       <header className="flex justify-between max-w-5xl mx-auto my-4"> 
        ...
        <nav className="flex gap-4">
          <Link className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-" 
            href="/">Home</Link>
          <Link className="gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30"
